package io.github.ifris.uaa.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("ifrisuaa");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("ifrisuaa");
        ...
        config.getMapConfigs().put("io.github.ifris.uaa.domain.*", initializeDomainMapConfig(jHipsterProperties));
